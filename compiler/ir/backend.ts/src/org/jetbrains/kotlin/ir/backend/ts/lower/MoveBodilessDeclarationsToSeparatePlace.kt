...
package org.jetbrains.kotlin.ir.backend.ts.lower

import org.jetbrains.kotlin.backend.common.DeclarationTransformer
import org.jetbrains.kotlin.backend.common.compilationException
import org.jetbrains.kotlin.ir.backend.ts.TsIrBackendContext
import org.jetbrains.kotlin.ir.backend.ts.utils.getJsModule
import org.jetbrains.kotlin.ir.backend.ts.utils.getJsQualifier
...
fun moveBodilessDeclarationsToSeparatePlace(context: TsIrBackendContext, moduleFragment: IrModuleFragment) {
...
class MoveBodilessDeclarationsToSeparatePlaceLowering(private val context: TsIrBackendContext) : DeclarationTransformer {
